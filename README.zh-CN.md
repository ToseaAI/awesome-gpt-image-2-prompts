<h1 align="center">Awesome GPT Image 2 Prompts · 精选集</h1>

<p align="center"><i>像素级文字掌控,商用级画面质感。每日精选 prompt。</i></p>
...
> 注:当前条目标题保留 prompt 原文语言(多为英文),中文翻译版本正在规划中。
...
*作者 [**Alex Patrascu**](https://x.com/maxescu/status/2045096239713394862)*
...
欢迎 PR。**请只修改 `prompts.json`** —— README 由 `scripts/build_readmes.py` 自动生成,手动改会在合并时被覆盖。数据结构参见 [CONTRIBUTING.md](CONTRIBUTING.md)。

## 许可协议

本合集采用 [CC BY 4.0](LICENSE) 协议。每条 prompt 的著作权仍归原作者所有,本仓库仅负责整理、翻译与分类。
